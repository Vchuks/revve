...
const Shop = () => {
  return (
    <div className="bg-[#F2F2F2] grid grid-flow-col lg:grid-rows-6 px-3 md:pl-10 lg:pl-14 xl:pl-20 md:pr-10 lg:pr-0 gap-6 md:gap-2 items-center lg:items-end py-10 md:py-20 lg:pb-20 lg:pt-40">
      <div
        className="flex flex-col gap-4 md:gap-14 col-start-1  col-span-3 md:col-span-1 lg:row-span-5"
        data-aos="fade-up"
      ...
      <div
        className="col-start-1 col-span-3 md:col-span-1 md:col-start-2 lg:row-span-5"
        data-aos="zoom-in"
        data-aos-duration="2000"
        data-aos-easing="ease-in-out"
      >
